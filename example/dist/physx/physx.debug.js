...
function createWasm() {
  ...
  function instantiateArrayBuffer(receiver) {
    return getBinaryPromise().then(function(binary) {
      console.log('instantiateArrayBuffer', binary, String.fromCharCode.apply(null, new Uint16Array(binary)), info)
  ...
  function instantiateAsync() {
    console.log('instantiateAsync', wasmBinary, wasmBinaryFile)
    if (!wasmBinary &&

import { Quaternion, Vector3, Matrix4, BufferGeometry, Box3, } from 'three';
...
(function (Shape) {
    ...
    Shape[Shape["CYLINDER"] = 1] = "CYLINDER";
    Shape[Shape["SPHERE"] = 2] = "SPHERE";
    Shape[Shape["HULL"] = 3] = "HULL";
    Shape[Shape["MESH"] = 4] = "MESH";
})(Shape || (Shape = {}));
export const threeToPhysXModelDescription = (object, options = {}) => {
    let geometry;
 ...
 * @return {BodyShape}
 */
const createBoundingBoxShape = (object) => {
    const box = new Box3();
...
function createConvexPolyhedron(object) {
    ...
    if (!geometry || !geometry.attributes.position.count)
        return null;
...
export function getGeometry(object) {
    let mesh, tmp = new BufferGeometry();
...
export function getVerticesIndices(geometry) {
    ...
    const indices = ((_a = geometry.index) === null || _a === void 0 ? void 0 : _a.array) || Object.keys(vertices).map(Number);
...
//# sourceMappingURL=threeToPhysXModelDescription.js.map